...
def L_model_forward(X, parameters):
    ...
    W = parameters["W" + str(L)]
    b = parameters["b" + str(L)]
    AL, cache = linear_activation_forward(A_prev, W, b, "lineal")
    caches.append(cache)
    ### END CODE HERE ###
...
def compute_cost(AL, Y):
    ...
    cost = 1/m*np.sum(np.absolute(AL-Y))
...
def L_model_backward(AL, Y, caches):
    ...
    grads["dA" + str(L-1)], grads["dW" + str(L)], grads["db" + str(L)] = \
             linear_activation_backward(dAL, current_cache, "lineal")
    ### END CODE HERE ###
